...
describe("Test ShowQuote", function () {
  ...
  test("renders", function () {
    render(<ShowQuote currentQuote={null} getQuote={null} />);
  });

  test("shows the button initial placeholder when no quote is passed in", function () {
    const result = render(<ShowQuote currentQuote={null} getQuote={null} />);
  ...
  test("shows the button a new placeholder when a quote is passed in", function () {
    const result = render(<ShowQuote currentQuote={quote} getQuote={null} />);
  ...
  it("button works ", function () {
    ...
    const { container } = render(<ShowQuote currentQuote={null} getQuote={handleClick} />);
